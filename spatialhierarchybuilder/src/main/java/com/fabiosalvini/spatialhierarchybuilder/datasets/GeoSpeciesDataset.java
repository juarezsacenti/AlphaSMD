...
public class GeoSpeciesDataset implements Dataset {
	
	public static final String DOMAIN = "rdf.geospecies.org";
	...
	private static GeoSpeciesDataset singleton = new GeoSpeciesDataset();

	private GeoSpeciesDataset() {
	...
	public static GeoSpeciesDataset getSingleton() {
		return singleton;
	}
