...
public class OpenGisDataset implements Dataset {
	...
	private static OpenGisDataset singleton = new OpenGisDataset();

	private OpenGisDataset() {
	...
	public static OpenGisDataset getSingleton() {
		return singleton;
	}
