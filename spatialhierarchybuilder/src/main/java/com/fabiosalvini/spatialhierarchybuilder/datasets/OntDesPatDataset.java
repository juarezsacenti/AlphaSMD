...
public class OntDesPatDataset implements Dataset {
	
	public static final String DOMAIN = "ontologydesignpatterns.org";
	...
	private static OntDesPatDataset singleton = new OntDesPatDataset();

	private OntDesPatDataset() {
	...
	public static OntDesPatDataset getSingleton() {
		return singleton;
	}
