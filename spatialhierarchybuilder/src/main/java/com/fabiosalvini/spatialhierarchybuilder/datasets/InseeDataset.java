...
public class InseeDataset implements Dataset {
	
	public static final String DOMAIN = "rdf.insee.fr";
	...
	private static InseeDataset singleton = new InseeDataset();

	private InseeDataset() {
	...
	public static InseeDataset getSingleton() {
		return singleton;
	}
