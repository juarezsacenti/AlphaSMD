...
public class FreebaseDataset implements Dataset {
	
	public static final String DOMAIN = "rdf.freebase.com";
	...
	private static FreebaseDataset singleton = new FreebaseDataset();

	private FreebaseDataset() {
	...
	public static FreebaseDataset getSingleton() {
		return singleton;
	}
